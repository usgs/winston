...
public class Channel implements Comparable<Channel> {
     ...
     */
    public String toMetadataString(int maxDays) {
        return String.format("%s:%s:%s:%s:%f:%f:%s:", toPV2String(maxDays), instrument.getTimeZone(), alias, unit, linearA,
                linearB, getGroupString());
    }
     ...
     */
    public String toPV2String(int maxDays) {
        double min = minTime;
        double max = maxTime;
        ...
        return String.format("%d:%s:%f:%f:%f:%f", sid, code, minTime, maxTime, instrument.getLongitude(),
                instrument.getLatitude());
    }
