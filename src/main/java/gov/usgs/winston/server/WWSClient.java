...
public class WWSClient extends WaveServer {
    ...
    public Wave getWave(String station, String comp, String network, String location, double start, double end,
            boolean compress) {
    ...
    public HelicorderData getHelicorder(String station, String comp, String network, String location, double start,
            double end, boolean compress) {
    ...
    public RSAMData getRSAMData(String station, String comp, String network, String location, double start, double end,
            int period, boolean compress) {
        String req = String.format(Locale.US, "GETSCNLRSAMRAW: GS %s %s %s %s %f %f %d %s\n", station, comp, network,
                location, start, end, period, (compress ? "1" : "0"));
        byte[] buf = getData(req, compress);
        if (buf == null)
            return null;
    ...
    public static void outputSac(String server, int port, Double st, Double et, String c, String fn, double gulpSize,
            double gulpDelay) {
