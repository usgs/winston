...
abstract public class BaseCommand implements Command {
	...
	protected void sendNoChannelResponse(String id, int pin, String s, String c, String n, String l,
	...
	public int writeWaveAsAscii(Wave wave, int sid, String id, String s, String c, String n, String l, double t1,
			double t2, String fill, SocketChannel channel) {
